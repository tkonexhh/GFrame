...
namespace GFrame
{
    public static class Draw
    {
        ...
        /// </summary>
        public static Color DrawDefaultColor = Color.red;
        ...
        private static void CheckAndBuildHiddenRTDrawObject()
        {
            ...
            _rtDraw = GameObject.FindObjectOfType<GFrame.Internal.RuntimeDebugDraw>();
            if (_rtDraw != null)
                return;
            ...
            _rtDraw = childGo.AddComponent<GFrame.Internal.RuntimeDebugDraw>();
    ...
    public static class DrawEditor
    {
        static DrawEditor()
        {
            ...
            var name = typeof(GFrame.Internal.RuntimeDebugDraw).Name;
            foreach (MonoScript monoScript in MonoImporter.GetAllRuntimeMonoScripts())
            {
                if (name != monoScript.name)
                    continue;

                if (MonoImporter.GetExecutionOrder(monoScript) != 9990)
                {
                    MonoImporter.SetExecutionOrder(monoScript, 9990);
                    return;
                }
            }
        }
