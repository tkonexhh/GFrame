...
namespace GFrame
{
    ...
    public class SqliteDatabase
    {
        ...
        public SqliteDatabase(string dbPath)
        {
            ...
            pathDB = FilePath.persistentDataPath4DataBase + dbName;// System.IO.Path.Combine(Application.persistentDataPath, dbName);
            //original path
            string sourcePath = dbPath;//System.IO.Path.Combine(Application.streamingAssetsPath, dbName);
