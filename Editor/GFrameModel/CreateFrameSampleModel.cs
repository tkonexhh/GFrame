...
public class CreateFrameSampleModel : EditorWindow
{
    [MenuItem("Assets/Create/Script/CreateFrameSampleScripts", priority = 0)]
    private static void CreateFrameScripts()
    {
        ProjectWindowUtil.StartNameEditingIfProjectWindowExists(0,
                    ...
                    "Assets/GFrame/Editor/GFrameModel/modelSampleScript.cs.txt");
    }
